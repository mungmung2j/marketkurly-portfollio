...
export default function Section5Component({viewProductSetter}){
    ...
    React.useEffect(()=>{
        ...
        .then((res)=>{
            if(res.status===200){
                setState({
                    "캡션1":res.data.section5.caption.캡션1,
                    "캡션2":res.data.section5.caption.캡션2,
    ...
    return(
        <section id="section5" className="intro-slide20">
            <div className="container">
                <div className="title">
                    <h2><a href="!#">{state.캡션1}</a></h2>
                    <h3>{state.캡션2}</h3>
                </div>
                        ...
                        <div className="slide-view">
                            <ul ref={refSlideWrap} className="slide-wrap">
                                {state.product.map((item, idx)=>{
                                    ...
                                    <div className="gap" onClick={(e)=>onClickViewProduct(e, item, './img/intro/section5/')}>
                                        <div className="img-box"><img src={`./img/intro/section5/${item.제품이미지}`} alt="" /></div>
